...
function reinova_theme_v1_regions() {
  return array('sidebar_right' => t('Right sidebar'),
 ...
 * @ingroup themeable
 */
function reinova_theme_v1_menu_local_task($mid, $active, $primary) {
  $active_class = "";
  if ($active) {
    $active_class .= "active ";
  }
 ...
 *   The url of the feed.
 */
function reinova_theme_v1_feed_icon($url) {
 ...
 */
function reinova_theme_v1_comment_wrapper($content, $type = null) {
  static $node_type;
 ...
 */
function reinova_theme_v1_breadcrumb($breadcrumb) {
  if (!empty($breadcrumb)) {
    return '<div class="breadcrumb art-postcontent">'. implode(' | ', $breadcrumb) .'</div>';
  }
}

function reinova_theme_v1_service_links_node_format($links) {
 ...
 * @ingroup themeable
 */
function reinova_theme_v1_button($element) {
...
*/
function reinova_theme_v1_img_assist_page($content, $attributes = NULL) {
