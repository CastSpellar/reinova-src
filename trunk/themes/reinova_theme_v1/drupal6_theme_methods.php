...
function reinova_theme_v1_menu_local_task($link, $active = FALSE) {
  $active_class = "";
  if ($active) {
    $active_class .= "active ";
  }
 ...
 *   A descriptive title of the feed.
  */
function reinova_theme_v1_feed_icon($url, $title) {
 ...
 */
function reinova_theme_v1_preprocess_comment_wrapper(&$vars) {
