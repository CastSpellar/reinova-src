...
function reinova_theme_v1_breadcrumb($variables) {
 ...
 * @ingroup themeable
 */
function reinova_theme_v1_button($variables) {
 ...
 */
function reinova_theme_v1_preprocess_page(&$vars) {
 ...
 * @ingroup themeable
 */
function reinova_theme_v1_menu_local_task($variables) {
 ...
 */
function reinova_theme_v1_feed_icon($variables) {
...
$tags = isset($content['field_tags']) ? render($content['field_tags']) : '';
  if (!empty($tags)) {
  ob_start();?>
